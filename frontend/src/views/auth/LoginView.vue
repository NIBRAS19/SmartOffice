<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="card p-8 space-y-6" @submit.prevent="handleLogin">
        <div>
      ...
      <div class="text-center text-xs text-gray-500">
        ...
        <p class="mt-1">Admin: admin@smartoffice.com / password</p>
        <p>Manager: manager@smartoffice.com / password</p>
        <p>Staff: staff@smartoffice.com / password</p>
      </div>
    </div>
  </div>
</template>
